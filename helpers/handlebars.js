...
module.exports={
    ...
    paginate:function(options){
        ...
        if(options.hash.current===1){
            output+=`
                <li class='page-item'><a class="disabled page-link">First</a></li>
            `;
        }else{
            output+=`
            <li class='page-item'><a href="?page=1" class="disabled page-link">First</a></li>
        `;
        }
        ...
        if(options.hash.current===options.hash.pages){
            ...
            output+=`
                <li class='page-item'><a href="?page=${options.hash.pages}" class="page-link">Last</a></li>
            `;  
        }
